...
de 0 até 5. Para mostrar o último carcatere, você tem que subtrair 1 do 
tamanho ({\tt length}):
...
\item[procura:] Um padrão que percorre e para quando encontra o que está
	procurando.
...
\index{slice}
\item[fatia:] Uma parte da string especificado por um 
...
\url{https://docs.python.org/2/library/stdtypes.html#string-methods}.
Você pode querer experimentar alguns destes métodos para ter certa que
...
opcional. Dest forma, {\tt sub} é obrigatório, mas {\tt start} é opcional, e
